...
$env:NODE_VIRTUAL_ENV="C:\Users\berna\OneDrive\Documents\GitHub\WADS-W11-Assignment\WADS-11-Assignment"
...
function global:prompt {
    Write-Host -NoNewline -ForegroundColor Green '(WADS-11-Assignment) '
    _OLD_VIRTUAL_PROMPT
}
